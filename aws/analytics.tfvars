...
s3_bucket_name_cloudtrail = "anal-dev-env-trial-logs" #s3 bucket name to manage cloudtrail logs
...
s3_bucket_name_hds_analytics = "openidl-anal-hds-analytics-data"
