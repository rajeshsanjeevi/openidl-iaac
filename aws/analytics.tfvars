...
domain_info = {
  ...
  sub_domain_name = "analytics" #sub domain
  comments = "analytics node domain"
}
...
client_callback_urls         = ["https://openidl-dev-analytics.thetech.digital/callback", "https://openidl-dev-analytics.thetech.digital/redirect"] #ensure to add redirect url part of callback urls, as this is required
client_default_redirect_url  = "https://openidl-dev-analytics.thetech.digital/redirect" #redirect url
client_logout_urls           = ["https://openidl-dev-analytics.thetech.digital/signout"] #logout url
cognito_domain               = "analytics-openidl" #unique domain name
...
tfc_workspace_name_aws_resources = "openidl-anal-aws-resources"
