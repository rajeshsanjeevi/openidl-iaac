...
client_callback_urls         = ["https://openidl-dev-carrier.thetech.digital/callback", "https://openidl-dev-carrier.thetech.digital/redirect"] #ensure to add redirect url part of callback urls, as this is required
client_default_redirect_url  = "https://openidl-dev-carrier.thetech.digital/redirect" #redirect url
client_logout_urls           = ["https://openidl-dev-carrier.thetech.digital/signout"] #logout url
cognito_domain               = "carrier-openidl" #unique domain name
...
s3_bucket_name_cloudtrail = "openidl-cloudtrail-logs" #s3 bucket name to manage cloudtrail logs
